      ...
      <section className="grid gap-4 xl:grid-cols-3">
        <Card className="bg-white/95">
          ...
          <CardContent className="space-y-3 text-sm leading-6 text-muted-foreground">
            <div className="rounded-3xl bg-background/80 p-4"><p className="font-medium text-foreground">실명</p><p>{teacherProfile.realName}</p></div>
            <div className="rounded-3xl bg-background/80 p-4"><p className="font-medium text-foreground">닉네임</p><p>{teacherProfile.nickname}</p></div>
          </CardContent>
        </Card>
        <Card className="bg-white/95">
          <CardHeader>
          ...
          <CardContent className="space-y-3 text-sm leading-6 text-muted-foreground">
            <div className="rounded-3xl bg-background/80 p-4"><p className="font-medium text-foreground">기본 태그</p><Badge className="mt-2">[필독]</Badge></div>
            <div className="rounded-3xl bg-background/80 p-4"><p className="font-medium text-foreground">공지 노출 범위</p><p>클래스 전체 / 모둠별 공지 흐름 확장 가능</p></div>
          </CardContent>
        </Card>
        <Card className="bg-white/95">
          <CardHeader>
          ...
          <CardContent className="space-y-3 text-sm leading-6 text-muted-foreground">
            <div className="rounded-3xl bg-background/80 p-4">코드는 헤더와 우측 패널 모두에서 확인할 수 있도록 설계합니다.</div>
            <div className="rounded-3xl bg-background/80 p-4">실제 로직 연결 전까지는 읽기 전용 상태와 액션 버튼만 제공합니다.</div>
          </CardContent>
        </Card>
      </section>
    </>
